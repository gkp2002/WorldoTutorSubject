...
//  const [cources,setcources] = useState("Maths");
  ...
  return (
    <div>
      <nav className= {position?"flex justify-between bg-blue-400 shadow-xl  fixed z-50 w-full ":"flex justify-between  bg-blue-gray-50 "}>
        <div className="flex py-5 pl-10 cursor-pointer">
          <Link to="/">
            <div id="Logo">
              <img
